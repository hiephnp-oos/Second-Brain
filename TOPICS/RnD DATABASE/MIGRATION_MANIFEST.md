...
The migrated source tree under `TOPICS/RnD DATABASE/` is the current detailed project source. Validate the expected three-layer structure and compare future migrations against the source package inventory before replacing the current baseline.
