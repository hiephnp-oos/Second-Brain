...
This topic is organized as a parent folder so each recurring R&D workstream can keep its own artifacts while this file remains the routing and summary layer.
...
Add new R&D workstream folders here as the need emerges. The parent file should be updated so a new AI can discover and route to the new folder without assuming a fixed four-folder structure.
