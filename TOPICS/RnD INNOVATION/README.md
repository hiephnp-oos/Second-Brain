...
- State: Active
- Summary: R&D innovation capability is organized into Personal Research, Knowledge Sheet + Claw, Existing Ideas, and Bi-weekly Review. Project Improvement & Governance is maintained under Personal Research.
...
`Knowledge sheet/Prompt.csv` is the team-released prompt library. The other workstream `Prompt.csv` files are maintainer/workstream task interfaces.
...
- This topic has four active workstreams: Knowledge Sheet, Personal Research, Existing Ideas, and Bi-weekly Review.
