...
One known project is the DNF R&D Database, a Google Sheets + Apps Script based R&D data management system involving BOM, Material, Cost, Drawing, SAP integration, search, automation, auditing, and maintenance.
...
The project is a significant software/engineering workstream but is only one part of the user's broader work.
