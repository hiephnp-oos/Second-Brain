...
- Every Monday, after synthesis and validation, write/update exactly one compact weekly run record at `TOPICS/2. CAREER/4. RUNS/YYYY-W##.md`.
...
7. If Monday, write/update the compact weekly run record in `TOPICS/2. CAREER/4. RUNS/`.
...
Each `TOPICS/2. CAREER/4. RUNS/YYYY-W##.md` file should remain compact and contain:
